...
export const cursos: Curso[] = [
  {
    ...
    vsl: {
      ...
      garantia: 'Curso 100% gratuito. Conteúdo em PDF. Sem suporte individual.',
  ...
  },
  {
    ...
    vsl: {
      ...
      garantia: 'Conteúdo em PDF. Acesso imediato após pagamento. Sem suporte individual.',
      valorReal: 'R$ 497,00',
      urgencia: 'Acesso imediato após pagamento.',
    },
    modulos: [
      {
  ...
  },
  {
    ...
    vsl: {
      ...
      garantia: 'Conteúdo em PDF. Acesso imediato. Sem suporte individual.',
      valorReal: 'R$ 297,00',
      urgencia: 'Acesso imediato após pagamento.',
    },
    modulos: [
  ...
  },
  {
    ...
    vsl: {
      ...
      garantia: 'Curso 100% gratuito. Conteúdo em PDF.',
