...
export const cursos: Curso[] = [
  ...
  },
  {
    ...
    bonus: [
      ...
      'BONUS 2 · Framework MARG para validar produto antes de comprar (R$ 47)',
      'BONUS 3 · 50 templates de título que vendem (R$ 97)',
      'BONUS 4 · 20 respostas template para perguntas ML (R$ 27)',
      'BONUS 5 · Checklist setup completo de conta + Mercado Pago + Envios (R$ 27)',
    ],
    paraQuem: [
      'Iniciante absoluto que nunca vendeu no ML mas quer entrar com método',
      'Vendedor já operando mas estagnado em R$ 3-15k/mes (Categoria 2)',
      'Vendedor médio (R$ 15-50k/mes) querendo virar Mercado Líder Gold',
      'Empreendedor que quer renda extra vendendo produtos de revenda',
      'Quem já vende em outras plataformas e quer entrar no ML',
      'Vendedor que tentou ML antes e desistiu — quer voltar com sistema',
      'Pessoa em transição de emprego buscando autonomia financeira',
      'Quem quer entender como o algoritmo do ML decide quem aparece',
    ],
    oQueVaiAprender: [
      'Os 5 níveis de reputação ML e como subir de Verde para Mercado Líder Gold',
      'O algoritmo ML 2026 — os 7 fatores que decidem onde seu anúncio aparece',
      'Framework PVPC para diagnosticar por que sua venda caiu',
      'Framework MARG para validar produto ANTES de comprar estoque',
      'Como achar produto vencedor — 6 fontes de revenda no Brasil',
      '3 níveis de validação de demanda — do gratuito ao teste real',
      'Calcular margem líquida real (comissão + frete + imposto + embalagem)',
      'Anatomia do título perfeito ML 2026 — 60 caracteres que vendem',
      'Como produzir 6 fotos profissionais com celular e R$ 50-200',
      'Template de 8 partes para descrição que converte',
      'Mercado Ads com R$ 10/dia e ROAS 5x (sem queimar grana)',
      'Full vs Flex vs Coletas — qual usar quando',
      'Embalagem profissional que reduz quebra e aumenta avaliação',
      '20 templates de resposta rápida para 80% das perguntas',
      'As 4 alavancas de escala — de R$ 5k para R$ 100k/mes',
    ],
    vsl: {
      hook: 'Mercado Livre — O Curso Definitivo. Os macetes de 20 anos no maior marketplace do BR.',
      subhook: '96 páginas escritas por quem vende desde 2005 — do primeiro Nescau no condomínio a Mercado Líder. Frameworks PVPC e MARG. Algoritmo ML 2026 destrinchado. Mercado Ads sem queimar grana. De R$ 297 por R$ 9,90.',
      problemas: [
        'Já abriu conta ML mas vende menos de R$ 500/mes e não sabe por que',
        'Posta anúncios mas eles não aparecem na primeira página',
        'Calcula preço mas no fim do mês descobre que teve prejuízo',
        'Tentou Mercado Ads e queimou R$ 500 sem retorno',
        'Reputação caiu para amarela e não sabe como recuperar',
        'Quer escalar mas trabalha 60h/semana e não cresce',
      ],
      transformacao: 'Em 14 módulos progressivos, você sai do absoluto zero (não vende nada) até operar como vendedor profissional com Mercado Líder Gold em 12-18 meses. Não é curso de informação — é curso de OPERAÇÃO. Cada módulo termina com entregável obrigatório. Você sai com sistema, não com "ideias".',
      antesDepois: [
        { antes: 'Vendia sem calcular margem, descobria prejuízo no fim do mês', depois: 'Calcula margem líquida por SKU, sabe exato quanto lucra' },
        { antes: 'Anúncios na página 5, vendendo 5/mes por SKU', depois: 'Top 5 da página 1 com framework PVPC' },
        { antes: 'Queimava R$ 300/mes em Ads sem retorno', depois: 'Mercado Ads R$ 15/dia com ROAS 5x consistente' },
        { antes: 'Cancela venda quando falta estoque, reputação caindo', depois: 'Compra fora pra entregar, mantém Mercado Líder' },
        { antes: 'Demora 6h para responder pergunta, perde venda', depois: '20 templates configurados, resposta em <2min' },
        { antes: 'Era executor que reagia a problemas', depois: 'É estrategista que opera com PVPC e MARG' },
      ],
      depoimentos: [
        { nome: 'Carlos Eduardo, 38 anos', cidade: 'São Paulo · vendedor há 2 anos', texto: 'Estava travado em R$ 4k/mes vendendo eletrônicos. Apliquei o PVPC e descobri que minha vitrine estava errada. Em 60 dias subi para R$ 11k. Em 6 meses, Mercado Líder Clássico.' },
        { nome: 'Fernanda Lima, 32 anos', cidade: 'Belo Horizonte · iniciante', texto: 'Comecei do zero seguindo o curso. Em 4 meses estava faturando R$ 7k/mes vendendo utensílios de cozinha. O framework MARG salvou de comprar R$ 8k em estoque que não venderia.' },
        { nome: 'Roberto Santos, 45 anos', cidade: 'Recife · pequeno vendedor', texto: 'Vendia há 5 anos mas estagnado. Capítulo do algoritmo ML me ensinou os 7 fatores que eu não conhecia. Em 90 dias dobrei o faturamento sem aumentar estoque.' },
        { nome: 'Patrícia Almeida, 29 anos', cidade: 'Florianópolis · empreendedora', texto: 'A parte de Mercado Ads vale 100x o preço. Tinha queimado R$ 800 em campanha errada. Refiz com o método do curso, ROAS subiu para 6,2. Vale cada centavo.' },
      ],
      objecoes: [
        { pergunta: 'Funciona pra quem nunca vendeu no ML?', resposta: 'Sim. O Módulo 0 começa do absoluto zero — explica como o ML funciona, os 7 mitos perigosos, o framework PVPC que você vai usar a vida toda. Não precisa saber nada antes.' },
        { pergunta: 'Funciona pra vendedor já experiente?', resposta: 'Sim. Os Módulos 9 (algoritmo), 11 (Mercado Ads) e 14 (escala) entregam estado da arte 2026 que mesmo vendedor de 5 anos não conhece. Atualizações de algoritmo cobertas.' },
        { pergunta: 'Precisa de CNPJ pra começar?', resposta: 'Não. O Módulo 1 explica quando você começa como pessoa física, quando vira MEI (R$ 67/mes) e quando precisa ME/LTDA. PF atende até R$ 8k/mes tranquilamente.' },
        { pergunta: 'É vídeo ou PDF?', resposta: 'PDF de 96 páginas com design editorial premium. Você baixa e acessa pra sempre. Sem mensalidade, sem login expirando.' },
        { pergunta: 'Por que tão barato (R$ 9,90)?', resposta: 'Preço de lançamento. Vai subir gradualmente. Quem compra agora trava o preço e tem acesso vitalício.' },
        { pergunta: 'Vai ficar desatualizado?', resposta: 'Os frameworks (PVPC, MARG, 7 fatores) são perenes. ML faz mudanças mas as bases não mudam. Atualizações anuais inclusas pra mudanças relevantes da plataforma.' },
      ],
      garantia: 'PDF de 96 páginas entregue por email imediatamente após pagamento. Sem letrinha miúda. Sem mensalidade. Acesso pra sempre.',
      valorReal: 'R$ 297,00 (equivalente a 5 cursos especializados de ML)',
      urgencia: 'Preço de lançamento R$ 9,90. Trava o preço agora.',
    },
    modulos: [
      { titulo: 'Módulo 0 — A Realidade do Marketplace BR', aulas: ['19 anos de operação ML — números reais', '218 milhões de usuários, 14 milhões vendendo', 'A comissão real (Clássico 11% vs Premium 18%)', 'Os 4 tipos de vendedor ML', 'Os 7 mitos perigosos que custam dinheiro', 'Framework próprio PVPC — Produto · Vitrine · Posição · Confiança'] },
      { titulo: 'Módulo 1 — Setup Completo da Conta', aulas: ['PF vs MEI vs ME — quando migrar', 'Cadastro com os campos certos', 'Mercado Pago — configuração de saque', 'Mercado Envios — Full vs Flex vs Coletas', 'Ferramentas obrigatórias (grátis e pagas)', 'Checklist de setup completo'] },
      { titulo: 'Módulo 2 — As 4 Categorias de Vendedor', aulas: ['Iniciante (R$ 0-3k) — Regular (R$ 3-15k) — Profissional (R$ 15-100k) — Elite (R$ 100k+)', 'Os abismos entre categorias', 'Mercado Líder Clássico, Gold e Platinum', 'Os 3 macetes pra subir nível', 'Diagnóstico — em qual categoria você está'] },
      { titulo: 'Módulo 3 — Onde Achar Produtos Vencedores', aulas: ['As 6 fontes de produto (distribuidor, indústria, atacado, importação, dropshipping, supermercado)', 'Os 6 nichos evergreen que sempre vendem', 'Nichos de alta margem e os que parecem bom mas não são', 'Framework próprio MARG'] },
      { titulo: 'Módulo 4 — Validação de Demanda', aulas: ['O erro de R$ 14k que vou te evitar', '3 níveis de validação (manual, ferramenta, teste real)', 'Nubimetrics e Real Trends', 'Os 5 picos sazonais do calendário brasileiro', 'Análise dos top 5 concorrentes'] },
      { titulo: 'Módulo 5 — Precificação e Margem', aulas: ['Cálculo completo de lucro líquido', 'Comissão, taxa de parcelamento, frete, embalagem, imposto', 'Frete grátis — quando vale absorver', 'Preço dinâmico — teste A/B', 'Margem mínima aceita (>=25%)'] },
      { titulo: 'Módulo 6 — Título que Vende', aulas: ['Anatomia do título perfeito 2026', '60 caracteres na ordem certa', 'Pesquisa de keyword (Tendências ML, autocomplete)', 'Keyword long-tail', '50 templates de título por categoria'] },
      { titulo: 'Módulo 7 — Fotos Profissionais', aulas: ['As 6 fotos obrigatórias em todo anúncio', 'Equipamento R$ 50-200 e técnica', 'Fundo, luz, tripé, app de edição', 'Os 7 erros que matam anúncio'] },
      { titulo: 'Módulo 8 — Descrição que Converte', aulas: ['Template de 8 partes (headline, bullets, ficha, descrição, FAQ, prova, envio, CTA)', '10 perguntas FAQ que reduzem dúvida', '1500-3500 caracteres ideal'] },
      { titulo: 'Módulo 9 — Algoritmo ML e Ranking', aulas: ['Os 7 fatores que decidem ranking (relevância, preço, reputação, vendas, qualidade, frete, resposta)', 'Estratégias pra sair da página 5 e ir pra página 1', 'Caso real — top 5 em 60 dias'] },
      { titulo: 'Módulo 10 — Reputação e Mercado Líder', aulas: ['As 5 métricas que calculam reputação', 'Estratégia por nível (verde → Líder → Gold → Platinum)', 'Como lidar com reclamação — antes, durante, depois'] },
      { titulo: 'Módulo 11 — Mercado Ads', aulas: ['Os 3 tipos de Ads (Product, Brand, Display)', 'Criando primeira campanha — passo a passo', 'ROAS, CPA, CTR, CR — métricas que importam', 'Otimização semanal — ritual'] },
      { titulo: 'Módulo 12 — Logística', aulas: ['Full vs Flex vs Coletas — comparativo completo', 'Cálculo de tempo (custo invisível)', 'Embalagem profissional — checklist por tipo', 'Dicas que aumentam avaliação 5 estrelas'] },
      { titulo: 'Módulo 13 — Atendimento e Perguntas', aulas: ['Sistema de respostas rápidas — 20 templates', 'Situações delicadas (cliente chato, fora ML, reclamação)', 'Compromisso operacional — resposta <1h em 90%'] },
      { titulo: 'Módulo 14 — Escala e Próximos Passos', aulas: ['As 4 alavancas de escala (volume, variedade, marca, equipe)', 'Projeção de receita por estágio', 'Os 10 erros fatais que quebram vendedor ML', 'Plano estratégico 12 meses (entregável final)'] },
    ],
  },
  {
...
const RELATED_RULES: Record<string, string[]> = {
  'mercado-livre-definitivo': ['marketing-digital-definitivo', 'ia-chatgpt-completo', 'funis-de-vendas-simplificado'],
  'marketing-digital-definitivo': ['mercado-livre-definitivo', 'ia-chatgpt-completo', 'ia-marketing-digital-iniciantes'],
