...
const categorias: Categoria[] = [
  ...
  },
  {
    ...
    produtos: [
      ...
      {
        nome: 'Se o Conteúdo é Rei, o Contexto é Deus — Ícaro de Carvalho',
        desc: 'Visão brasileira sobre criação de conteúdo que vende. Estratégia, posicionamento e copywriting na prática.',
        preco: 'R$ 39 – R$ 49',
        loja: 'amazon',
        link: '#',
      },
