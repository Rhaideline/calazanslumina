...
const categorias: Categoria[] = [
  {
    ...
    subtitulo: 'Bodies, conjuntos e macacoes — priorize 100% algodao para a pele sensivel do bebe',
    ...
    produtos: [
      {
        nome: 'Kit 10 Pecas Roupas Bebe Menina (5 Camisetas + 5 Shorts)',
        desc: 'Kit sortido com 5 conjuntos para bebe menina. 100% algodao, estampas variadas e confortaveis.',
        ...
        destaque: true, tag: '-43% OFF', algodao: true,
      },
      {
        nome: 'Kit 12 Pecas Roupas Menino (6 Camisetas + 6 Bermudas)',
        desc: '6 conjuntos completos para menino. Sortido com estampas variadas. Algodao macio.',
      ...
      {
        nome: 'Kit 4 Vestidos Bebe Menina Verao Algodao',
        desc: '4 vestidos estampados com mangas franzidas. 100% algodao, fresquinhos para o verao.',
        ...
        destaque: true, tag: '-58% OFF', algodao: true,
      },
      {
        nome: 'Kit 6 Camisetas Manga Longa Bebe Menino',
        desc: '6 camisetas basicas lisas de manga longa. 100% algodao, cores sortidas. Essencial no enxoval.',
        ...
        tag: '-46% OFF', algodao: true,
      },
      {
        nome: 'Kit 4 Body + Calca Mijao Bebe Menina',
        desc: '2 bodies de manga curta + 2 calcas mijao. Kit essencial para recem-nascido. Algodao puro.',
      ...
      {
        nome: 'Macacão Elegante Bebe com Estampa de Frutas',
        desc: 'Macacao fofo com botoes frontais e estampa de frutas/vegetais. Tecido macio e confortavel.',
      ...
      },
      {
        ...
        desc: '2 casacos + 2 calcas de moletom peluciado. Quentinho e confortavel para o inverno.',
      ...
      {
        nome: 'Kit Moletom Bebe Menina Inverno (2 a 12 pecas)',
        desc: 'Conjunto moletom peluciado em varios tamanhos. Opcoes de 2, 6 ou 12 pecas.',
      ...
      {
        nome: 'Kit Bebe Menino Casual Verao (2 a 10 pecas)',
        desc: 'Conjuntos estilo casual minimalista para bebe menino. Algodao leve para o verao.',
      ...
      {
        nome: 'Conjunto Moletom Bebe Menino Estampas Divertidas',
        desc: 'Moletom para bebe menino com estampas fofas. Conforto e estilo no dia a dia.',
  ...
  },
  {
    ...
    produtos: [
      ...
      {
        nome: 'Cama Infantil Encanto com Colchao e Grades',
        desc: 'Cama infantil em MDF com design moderno, colchao incluido e grades de seguranca.',
  ...
  },
  {
    ...
    subtitulo: 'Lencos, shampoos, fraldas e produtos hipoalergenicos para a pele sensivel',
  ...
  },
  {
    ...
    produtos: [
      ...
      {
        nome: 'Garrafa Termica Infantil Ursinho 320ml Inox',
        desc: 'Garrafa termica em inox com canudo. Mantem temperatura 5h. Antiderrapante. Buba.',
    ...
    produtos: [
      {
        ...
        desc: 'Triciclo multifuncional que vira carrinho de bebe. Com empurrador e protecao solar. KaBaby.',
      ...
      },
      {
        ...
        desc: 'Carrinho de passeio estilo jipe com empurrador. Varios modelos disponiveis.',
