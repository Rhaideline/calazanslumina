...
export default async function CursoCidadePage({ params }: { params: Promise<{ slug: string; cidade: string }> }) {
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <ScrollReveal>
              <p className="text-brand-mint text-sm font-medium mb-4 uppercase tracking-wider">
                Curso {curso.gratuito ? 'Gratuito' : `R$ ${curso.preco},00`} · {cidade.nome}, MA
              </p>
              <h1 className="heading-1 mb-6">
                {curso.nome} para Brasileiros em{' '}
      ...
      {/* Por que fazer em {cidade} */}
      <section className="section-padding bg-white">
        <div className="container-main max-w-4xl">
          <ScrollReveal className="text-center mb-12">
            <h2 className="heading-2 text-brand-dark mb-4">
              Por que fazer este curso em <span className="text-brand-mint">{cidade.nome}</span>?
            </h2>
          </ScrollReveal>
          <ScrollReveal>
            <div className="bg-brand-bg rounded-2xl p-8 md:p-10">
              ...
              <p className="text-brand-dark/70 leading-relaxed">
                Com o curso <strong>{curso.nome}</strong>, você terá as ferramentas necessárias para se destacar
                no mercado de {cidade.nome} e região. {curso.gratuito
      ...
      {outrosCursos.length > 0 && (
        <section className="section-padding bg-brand-bg">
          <div className="container-main">
            <ScrollReveal className="text-center mb-12">
              <h2 className="heading-2 text-brand-dark mb-4">Outros cursos disponíveis em {cidade.nome}</h2>
            </ScrollReveal>
