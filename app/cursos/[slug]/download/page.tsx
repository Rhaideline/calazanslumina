      ...
      <div className="bg-white min-h-[60vh] flex items-center justify-center">
        <div className="text-center max-w-lg px-6">
          ...
          <p className="text-brand-dark/60 mb-2">
            O download do curso <strong className="text-brand-dark">{curso.nome}</strong> deve começar automaticamente.
          </p>
          <p className="text-brand-dark/40 text-sm mb-8">
            {curso.modulos.length} módulos · {totalAulas} aulas · Conteúdo completo
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/cursos" className="border border-brand-dark/20 text-brand-dark hover:bg-brand-bg px-6 py-3 rounded-full text-sm font-medium transition-colors text-center">
              Ver Outros Cursos
            </Link>
          </div>
        </div>
