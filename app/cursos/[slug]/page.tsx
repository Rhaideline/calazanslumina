          ...
          <ScrollReveal>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 md:p-10 mt-8 mb-8">
              ...
              <div className="flex items-center justify-center gap-3 bg-white/5 rounded-xl p-4 border border-white/10">
                ...
                <p className="text-white/50 text-xs text-left">Conteúdo entregue em formato PDF (ebook). Acesso imediato após o pagamento. Não oferecemos suporte individual — o material é autoexplicativo e completo.</p>
              </div>
            </div>
