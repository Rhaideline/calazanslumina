        ...
        <div className="container-main section-padding relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <ScrollReveal>
              ...
              <a
                href={curso.gratuito
                  ? `https://wa.me/5531982948067?text=${encodeURIComponent(`Olá! Quero acessar o curso gratuito "${curso.nome}" da Calazans Lumina`)}`
                  : `https://wa.me/5531982948067?text=${encodeURIComponent(`Olá! Quero adquirir o curso "${curso.nome}" da Calazans Lumina`)}`
                }
                target="_blank"
              ...
              >
                ...
                {curso.gratuito ? 'Acessar Gratuitamente' : `Comprar por R$ ${curso.preco},00`}
              </a>
            </ScrollReveal>
        ...
        <div className="container-main max-w-3xl">
          <ScrollReveal>
            ...
            <p className="text-white/50 text-lg mb-4">
              {curso.gratuito ? (
                <strong className="text-brand-mint font-serif text-4xl">GRATUITO</strong>
              ) : (
                <strong className="text-white font-serif text-4xl">R$ {curso.preco},00</strong>
              )}
            </p>
            <p className="text-white/40 mb-8">
              {curso.gratuito
                ? 'Acesso livre · PDF gratuito · Sem cadastro'
                : 'Pagamento único · Acesso imediato ao PDF · Sem mensalidade'
              }
            </p>
            <a
              href={curso.gratuito
                ? `https://wa.me/5531982948067?text=${encodeURIComponent(`Olá! Quero acessar o curso gratuito "${curso.nome}" da Calazans Lumina`)}`
                : `https://wa.me/5531982948067?text=${encodeURIComponent(`Olá! Quero comprar o curso "${curso.nome}" por R$ ${curso.preco},00`)}`
              }
              target="_blank"
              rel="noopener noreferrer"
              className="btn-primary text-base"
            >
              ...
              {curso.gratuito ? 'Acessar Gratuitamente' : `Comprar Agora por R$ ${curso.preco},00`}
            </a>
          </ScrollReveal>
        </div>
      </section>
