    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-surface">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit) => {
              ...
              return (
                <div key={benefit.title} className="p-6 rounded-xl bg-background border border-border hover:border-primary/50 transition">
                  <BenefitIcon className="w-12 h-12 text-primary mb-4" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial) => (
              <div key={testimonial.name} className="p-6 rounded-xl bg-background border border-border">
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {medsaasFeatures.map((feature) => {
              const FeatureIcon = feature.icon
              return (
                <div key={feature.title} className="p-6 rounded-xl bg-surface border border-border hover:border-primary/50 transition">
                  <FeatureIcon className="w-12 h-12 text-primary mb-4" />
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8 bg-surface/50">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            {faqs.map((faq) => (
              <div key={faq.q} className="p-6 rounded-xl bg-background border border-border">
