...
const cursosMenu = [
  ...
  { slug: 'ia-chatgpt-completo', nome: 'IA & ChatGPT Completo', desc: 'R$ 20 — Do zero ao avançado', icon: 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
  { slug: 'marketing-digital-iniciantes', nome: 'Marketing Digital', desc: 'R$ 20 — Fundamentos práticos', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
  { slug: 'google-meu-negocio-do-zero', nome: 'Google Meu Negócio', desc: 'R$ 20 — Domine o Maps', icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z' },
  { slug: 'redes-sociais-que-vendem', nome: 'Redes Sociais que Vendem', desc: 'R$ 20 — Estratégia Info-First', icon: 'M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z' },
  { slug: 'funis-de-vendas-simplificado', nome: 'Funis de Vendas', desc: 'R$ 20 — Automação de vendas', icon: 'M3 4h13M3 8h9m-9 4h6m4 0l4-4m0 0l4 4m-4-4v12' },
...
const navLinks = [
  ...
  { href: '/para-clinicas', label: 'Para Clinicas' },
