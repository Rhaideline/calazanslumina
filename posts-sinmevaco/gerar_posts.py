...
/* ---- foto opcional ---- */
/* Foto entra colorida — regra da casa. O scrim resolve a leitura do texto
   e o dourado sobre a imagem, sem lavar a cor. */
...
.photo::after{content:"";position:absolute;inset:0;
  background:
    linear-gradient(178deg, rgba(10,42,23,.28) 0%, rgba(13,20,15,.62) 46%, rgba(10,15,11,.93) 100%),
    radial-gradient(78% 58% at 22% 18%, rgba(15,106,61,.34) 0%, rgba(13,20,15,0) 62%)}
.t-claro .photo{filter:saturate(1.0) contrast(1.02)}
.t-claro .photo::after{background:
    linear-gradient(178deg, rgba(245,247,243,.55) 0%, rgba(245,247,243,.80) 44%, rgba(245,247,243,.96) 100%)}
.t-verde .photo::after{background:
    linear-gradient(178deg, rgba(15,106,61,.42) 0%, rgba(12,80,46,.72) 48%, rgba(9,58,33,.94) 100%)}
/* nos modelos que nascem sobre foto o scrim sobe menos, para a imagem aparecer */
.fotoframe .photo::after,.capafoto .photo::after,.tela .photo::after{
  background:linear-gradient(178deg, rgba(10,42,23,.20) 0%, rgba(13,20,15,.55) 42%, rgba(10,15,11,.92) 100%)}
